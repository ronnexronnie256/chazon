...
export default function NotificationsPage() {
  ...
  const getNotificationColor = (type: string) => {
    ...
    if (type.includes('FAILED') || type.includes('DISPUTE'))
          ...
          {isLoading ? (
            ...
            <Card className="p-12 text-center bg-white rounded-2xl shadow-sm border border-gray-200">
              ...
              <p className="text-gray-500 max-w-md mx-auto">
                {filter === 'unread'
                  ? "You don't have any unread notifications. Check back later for updates on your bookings and tasks."
                  : "When you receive updates about your bookings, tasks, or payments, they'll appear here."}
              </p>
            </Card>
          ) : (
            <>
