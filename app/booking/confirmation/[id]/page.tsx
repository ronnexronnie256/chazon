        ...
        <main className="flex-grow flex items-center justify-center">
          <div className="text-center">
            ...
            <p className="text-gray-600 mb-6">
              The booking you are looking for does not exist or could not be
              loaded.
            </p>
            <Link
              href="/bookings"
            ...
            <div className="p-6">
                    ...
                    <div className="flex items-center mt-1">
                      <div className="flex items-center">
                        ...
                        <span className="text-sm text-gray-600 ml-1">
                          {booking.service.steward.rating?.toFixed(1) || 'New'}{' '}
              ...
              {user && booking && booking.status === 'COMPLETED' && (
                <div className="border-t pt-6 mb-6">
                  ...
                  {!userReview && (
                    <div className="mb-6 p-4 bg-gray-50 rounded-lg">
                      {(() => {
                        const isClient = (booking as any).clientId === user.id;
                        const isSteward =
                          (booking as any).stewardId === user.id;
                  ...
                  {reviews.filter((r: any) => r.reviewerId !== user.id).length >
                    0 && (
                    <div>
                      <h3 className="text-lg font-medium text-gray-800 mb-3">
                        Other Reviews (
                        {
                          reviews.filter((r: any) => r.reviewerId !== user.id)
                            .length
                        }
                        )
                      </h3>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <p className="text-sm text-gray-600 mb-4">
              Show your appreciation by adding a tip. Tips go 100% to the
              steward.
            </p>
            <div className="mb-4">
